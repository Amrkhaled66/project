...
const CurrentOrderCard = ({ order }: { order: Order }) => {
  return (
    <div className="animate flex w-full cursor-pointer flex-col space-y-10 rounded-xl border-2 bg-white py-4 shadow-md hover:shadow-lg">
      ...
      <div className="flex w-full flex-col justify-center gap-y-4">
        <button className="animate mx-auto w-[90%] rounded-xl border border-black/70 bg-black py-3 text-white hover:bg-white hover:text-black lg:w-[80%]">
          View Order Details
        </button>
