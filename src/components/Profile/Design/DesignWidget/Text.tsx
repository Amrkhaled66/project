...
const Text = () => {
  ...
  // Selected zone now points to the ID, not the label
  ...
  const handleEdit = (z: any) => {
    setSelectedZone(z.id); // ← ID directly
    setFont(z.font);
    setText(z.text);
    setNotes(z.notes);
    setColor(z.color);
                ...
                >
                  ...
                  <div className="flex gap-3">
                    <motion.button
                      ...
                      className="rounded-lg animate bg-blue-50 p-2 text-blue-600 hover:bg-blue-100"
                    >
                      <Pencil size={17} />
                    </motion.button>
                    ...
                    <motion.button
                      ...
                      className="rounded-lg bg-red-50 p-2 animate text-red-600 hover:bg-red-100"
                    >
                      <Trash2 size={17} />
                    </motion.button>
                  </div>
